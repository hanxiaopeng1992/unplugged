...
在古希腊，一万曾被认为是一个十分巨大的数，人们称它为murias，最终变成了myriad一词，意为“无数”\cite{De-linfini-2018}。另一种则不这么想，阿基米德，这位古希腊伟大的数学家认为，即使是充满全宇宙的沙子数目，也可以用一个数代表。在阿基米德在他的著作《数沙者》开篇中说：
...
阿基米德认为填满宇宙“只”需要$10^{63}$粒沙子。这个宇宙的含义是指恒星天球，大约为两万倍地球的半径。今天我们知道可观测宇宙的尺寸大约为460亿光年，大约包含$3 \times 10^{74}$个原子\footnote{一说为$10^{80}$到$10^{87}$个基本粒子。}。在古希腊的时代，阿基米德的想法无疑是天才的，这几乎是无穷的具体化。无独有偶，佛教中也用“恒河沙数”来表达大到无法计算的数。在大乘佛教经典《金刚经》中，佛陀说：“以七宝满尔所恒河沙数三千大世界，以用布施。”
