...
\begin{wrapfigure}{L}{0.3\textwidth}
 \centering
 \includegraphics[scale=0.3]{img/Hoare.eps}
 \captionsetup{labelformat=empty}
 \caption{霍尔}
 \label{fig:Hoare}
\end{wrapfigure}
...
2015年后主流的编程环境都纷纷将Haskell中的可能函子引入以取代null来获取更安全的方法\footnote{例如Java和C++中的\texttt{Optional<T>}。}。
