...
\begin{tikzpicture}[scale=0.5]
  \matrix (m) [matrix of math nodes,
     ...
     \shortstack{Scrooge \\ McDuck} & \shortstack{Matilda \\ Duck} & \shortstack{Goosetail \\ Gander} & \shortstack{Hortense \\ McDuck} & \shortstack{Quackmore \\ Duck} & \shortstack{Daphne \\ Duck} \\
