...
Next we use list diagram to prove, the catamorphism on list is the folding computation $foldr$ essentially. List functor is a polynomial functor $\mathbf{ListF}\ A\ B = 1 + A \times B$. As the diagram commutes, we have:
