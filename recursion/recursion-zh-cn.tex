...
\begin{figure}[htbp]
 \centering
 \includegraphics[scale=0.4]{img/Hippasus.eps}
 \captionsetup{labelformat=empty}
 \caption{希帕索思（Hippasus of Metapontum）生于梅塔蓬图姆。公元前五世纪。}
 \label{fig:Meziriac}
\end{figure}
%\end{wrapfigure}

欧几里得算法是一把锋利的宝剑，但是它强大的递归原理被反过来指向了“万物皆数”的基石——万物可公度。一切事物和现象都可以归结为整数与整数的比。从而引发了毕达哥拉斯学派哲学思想的危机。约公元前470年，毕达哥拉斯学派的一个学生希帕索思（Hippasus）
