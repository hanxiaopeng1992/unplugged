...
无穷递归的一个数学与艺术的完美结合的例子是“分形”（fractal）。例如著名的分形图案“科克雪花”曲线可以通过这样的无穷递归规则来产生，对图形中的每个线段，均分为三段，以第二段为底向上方作出一个等腰三角形，然后再把这个底擦掉。

%\begin{wrapfigure}{R}{0.3\textwidth}
\begin{figure}[htbp]
 \centering
 \includegraphics[scale=1]{img/Koch-snow.eps}
 %\captionsetup{labelformat=empty}
 \caption{科克雪花曲线的递归生成规则}
 \label{fig:Koch-snow}
\end{figure}
%\end{wrapfigure}
