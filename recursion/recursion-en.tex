...
\markboth{Recursion}{Mathematics in Computer Programming}

\epigraph{GNU means \textbf{G}NU is \textbf{N}ot \textbf{Unix}}{--Richard Stallman}
...
People learn the nature with the help of numbers. We introduced the Peano axioms and the isomorphisms of natural numbers, like the list data structure in programming in previous chapter. Although we have the natural numbers, our building still need some critical corner stones. We use recursive definition without proof of the correctness, like the fraction for example.
