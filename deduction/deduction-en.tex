...
\begin{Exercise}
\Question{Use the fusion law to optimize the expression evaluation $eval = sum \circ map\ (product \circ (map\ dec))$}
\Question{How to expand all expressions from left?}
\Question{The following definition convert expression to string:
\[
