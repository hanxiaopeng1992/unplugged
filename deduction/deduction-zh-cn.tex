...
\path (0, 0)  node[rectangle, draw] (9) {9}
      ...
      (-5.5, 2) node[rectangle, draw] (789) {789}
      (-4, 2) node[rectangle, draw] (7x89) {$7 \times 89$}
      (-2.5, 2) node[rectangle, draw] (7+89) {$7 + 89$}
      (-2, 3) node[rectangle, draw] (78x9) {$78 \times 9$}
      (-0.5, 3)  node[rectangle, draw] (7x8x9) {$7 \times 8 \times 9$}
