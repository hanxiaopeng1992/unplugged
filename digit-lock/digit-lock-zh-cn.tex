...
\begin{figure}[htbp]
  \centering
  \subfloat[普通锁的密码盘都是从0到9的顺序。]{\includegraphics[scale=0.2]{img/normal-digits-order.eps}} \\
  \subfloat[密码盘上的10个数字顺序是随机的。]{\includegraphics[scale=0.2]{img/random-digits-order.eps}}
