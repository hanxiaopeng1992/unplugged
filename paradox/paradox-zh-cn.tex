...
传统上我们认为，艺术文学等领域，涉及人们的文化背景、感情和性格因素，是无法被机器替代的。2015年，德国斯图加特以南40公里的小镇图宾根大学大学的盖提斯，埃克，贝特格利用机器学习人类艺术家的风格，把图宾根镇的风景照片变换成了不同风格的艺术画作\cite{Gatys-2015}（图\ref{fig:style-transfer}）。
...
在随后的数年中，人工智能和机器学习突飞猛进地进入了各种领域。机器产生不同音乐家风格的音乐，机器翻译新闻稿和各种学术论文，机器处理医学图像并给出病理诊断，并且诊断的结果在准确程度上超越人类医生……
